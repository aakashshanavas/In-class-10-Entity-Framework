...
namespace In_class_10_Entity_Framework
{
    class Order
    {
        ...
        public List<OrderDetail> ProductList { get; set; }//Making collection of products
    }
    ...
    class Product
    {
        ...
        public List<OrderDetail> OrderList { get; set; }//Making collection of orders
    }
    ...
    class OrderDetailsContext: DbContext
    {
        ...
        string connectionString = "Server=(localdb)\\MSSQLLocalDB;Database=InClass10Demo;Trusted_Connection=True;MultipleActiveResultSets=true";
    ...
    class Program
    {
        static void Main(string[] args)
        {
            using (OrderDetailsContext context = new OrderDetailsContext())
            {
                ...
                Order order1 = new Order { CustName = "Aakash"};
                Order order2 = new Order { CustName = "Shiva" };
                Order order3 = new Order { CustName = "Varaha" };
               ...
               //Return Orders which has maximum quantity od a product
